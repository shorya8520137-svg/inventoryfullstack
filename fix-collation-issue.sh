...
# =====================================================
# FIX COLLATION MISMATCH - Self Transfer Tables
# =====================================================
# This script:
# 1. Checks existing table collations
# 2. Drops and recreates self_transfer tables with correct collation
# 3. Verifies the fix
# =====================================================
...
# Check existing tables collation
echo "📊 Current table collations in inventory_db:"
sudo mysql -e "
SELECT 
    TABLE_NAME,
    TABLE_COLLATION
...
echo ""
echo "🔧 Fixing self_transfer tables collation..."
echo ""
...
-- Create self_transfer table with utf8mb4_0900_ai_ci collation
...
-- Create self_transfer_items table with utf8mb4_0900_ai_ci collation
...
echo ""
echo "✅ All done! OrderSheet should now work correctly."
