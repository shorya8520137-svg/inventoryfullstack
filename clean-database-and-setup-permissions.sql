-- Clean Database and Setup Proper Permissions System
-- This script will:
-- 1. Delete all users except admin
-- 2. Clean up duplicate permissions
-- 3. Set up proper permission structure
-- 4. Ensure admin has all permissions
...
-- Store admin user info (just in case)
...
SELECT COUNT(*) as remaining_users, 'admin user count' as description FROM users;
SELECT id, name, email, role_name FROM users;

-- =====================================================
-- STEP 3: CLEAN UP DUPLICATE PERMISSIONS
-- =====================================================
...
-- =====================================================
-- STEP 4: INSERT CLEAN PERMISSION STRUCTURE
-- =====================================================
...
-- =====================================================
-- STEP 5: ENSURE SUPER_ADMIN ROLE EXISTS
-- =====================================================
...
-- =====================================================
-- STEP 7: ENSURE ADMIN USER HAS SUPER_ADMIN ROLE
-- =====================================================
...
-- Show all permissions assigned to super_admin
SELECT 
    p.category,
    p.name,
    p.display_name
