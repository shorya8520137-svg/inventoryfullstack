...
const PRODUCTS_API = "https://api.hunyhuny.org/api/products";
...
export default function TransferForm({ onClose }) {
    ...
    const checkStock = async (barcode) => {
        ...
        try {
            const res = await fetch(`https://api.hunyhuny.org/api/product-tracking/${barcode}`);
    ...
    const submitTransfer = async () => {
        ...
        try {
            ...
            const res = await fetch(`https://api.hunyhuny.org/api/self-transfer/create`, {
                method: "POST",
