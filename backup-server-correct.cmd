...
echo Creating backup of database: inventory_db_2026-09012026-1
ssh -i "C:\Users\Admin\awsconection.pem" ubuntu@16.171.197.86 "sudo mysqldump -u root -p inventory_db_2026-09012026-1 > stockiq_database_backup.sql"
...
echo Database: inventory_db_2026-09012026-1
echo.
echo CONTENTS:
echo =========
...
echo    - Database name: inventory_db_2026-09012026-1
...
echo - database\stockiq_database_backup.sql (database: inventory_db_2026-09012026-1)
